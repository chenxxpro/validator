...
public class Schemes {
    ...
    public static Scheme fixedLength(int fixedLength) {
        return new Scheme(
                ...
                .dontTrimValue()
                .message("{key}长度必须等于" + fixedLength);
    }
